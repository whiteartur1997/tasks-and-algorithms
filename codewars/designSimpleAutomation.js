...
//     const filteredCommands = commands.filter(command => command === "0" || command === "1")
//     for (let command of filteredCommands) {
//         switch (this.state) {
//             case this.states.start: {
//                 this.q1Handle(Number(command))
//                 break
//             }
//             case this.states.accept: {
//                 this.q2Handle(Number(command))
//                 break
//             }
//             case this.states.intermediate: {
//                 this.q3Handle(Number(command))
//                 break
//             }
//         }
//     }
...
// console.log(myAutomaton.readCommands(["0", "1", "1", "0", "1", "1", "1"]))